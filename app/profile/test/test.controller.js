(() => {
    ...
    function ProfileTestController(UserService, Constants, AppModalService, testResolve, $location, ProfileTestService, userTestsResolve, $log) {
        const vm = this;

        vm.test = {};
        vm.startBtnDisabled = true;
        vm.showStopBtn = false;
        ...
        function startTest() {
            ProfileTestService.startTest({ "testId": vm.test.id }).$promise.then(() => {
